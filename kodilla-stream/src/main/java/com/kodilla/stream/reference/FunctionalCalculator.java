...
//    Klasa FunctionalCalculator posiada cztery metody statyczne
//    (nie musisz tworzyć obiektu klasy FunctionalCalculator, aby ich użyć),
//    które wykonują podstawowe operacje matematyczne.
}